...
public enum RoleType implements Role {
    ROLE_POSTS_VIEWER, ROLE_POSTS_EDITOR(Set.of(ROLE_POSTS_VIEWER)),
    ROLE_ALBUMS_VIEWER, ROLE_ALBUMS_EDITOR(Set.of(ROLE_ALBUMS_VIEWER)),
    ROLE_USERS_VIEWER, ROLE_USERS_EDITOR(Set.of(ROLE_USERS_VIEWER)),
    ROLE_POSTS_MODERATOR(Set.of(ROLE_POSTS_VIEWER, ROLE_POSTS_EDITOR)),
    ROLE_ALBUMS_MODERATOR(Set.of(ROLE_ALBUMS_VIEWER, ROLE_ALBUMS_EDITOR)),
    ROLE_USERS_MODERATOR(Set.of(ROLE_USERS_VIEWER, ROLE_USERS_EDITOR)),
